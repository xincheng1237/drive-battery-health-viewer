...
一款面向 Windows 与 macOS 的开源硬件健康查看工具。它以只读方式展示硬盘状态、电池健康度与设备信息，并支持历史记录、批量管理、报告导出、在线检查更新、序列号隐私保护和七种界面语言。
...
- macOS 26 及以上版本适配 Liquid Glass 界面效果，macOS 13–15 保持原生卡片视觉

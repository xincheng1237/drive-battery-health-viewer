...
enum L10n {
    ...
    private static let tables: [AppLanguage: [String: String]] = [
        .english: [
            ...
            "menuEdit": "Edit", "menuView": "View", "menuWindow": "Window", "menuHelp": "Help",
            ...
            "powerOnHours": "Power-on time", "powerCycles": "Power cycles", "totalRead": "Total read", "totalWritten": "Total written",
            ...
            "overviewLimitations": "The app shows all information provided by macOS and the device. Temperature, power-on time, and lifetime read/write totals may be unavailable on some drives or connections.",
        ...
        .simplifiedChinese: [
            ...
            "menuEdit": "编辑", "menuView": "显示", "menuWindow": "窗口", "menuHelp": "帮助",
            ...
            "powerOnHours": "通电时间", "powerCycles": "通电次数", "totalRead": "总读取量", "totalWritten": "总写入量",
            ...
            "overviewLimitations": "这里已显示 macOS 和设备能够提供的信息；部分硬盘的温度、通电时间或累计读写量可能因硬件与连接方式不同而无法读取。",
        ...
        .russian: [
            "overviewLimitations": "Приложение показывает все данные, доступные macOS и устройству. Температура, время работы и общий объём чтения/записи могут быть недоступны для некоторых дисков или подключений.", "batteryHealthExplanation": "Состояние батареи основано на откалиброванной macOS максимальной ёмкости. Температура, управление зарядом, калибровка и округление могут давать небольшое отличие от простого расчёта полной ёмкости к проектной.", "powerConnectedNotCharging": "Питание подключено. Батарея заряжена или macOS временно питает Mac напрямую.", "internalBattery": "Встроенная литий-ионная батарея",
            "appName": "Состояние накопителей и батареи", "systemLanguage": "Язык системы", "overview": "Обзор", "history": "История", "settings": "Настройки", "about": "О программе", "menuEdit": "Правка", "menuView": "Вид", "menuWindow": "Окно", "menuHelp": "Справка",
        ...
        .japanese: [
            "overviewLimitations": "macOS とデバイスが提供できる情報をすべて表示しています。ドライブや接続方法によっては、温度、使用時間、累積読み書き量を取得できません。", "batteryHealthExplanation": "バッテリーの健康度は macOS が校正した最大容量に基づきます。温度、充電管理、校正、丸めにより、満充電容量÷設計容量の単純計算と少し異なる場合があります。", "powerConnectedNotCharging": "電源に接続されています。バッテリーが満充電か、macOS が一時的に Mac へ直接給電しています。", "internalBattery": "内蔵リチウムイオンバッテリー",
